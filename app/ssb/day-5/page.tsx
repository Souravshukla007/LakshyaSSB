                ...
                <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-brand-bg">
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        ...
                        <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-8 mb-16 reveal">
                            ...
                            <Link href="/dashboard" className="block group relative bg-brand-dark p-[2px] rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                        ...
                        <div className="grid lg:grid-cols-12 gap-12">
                            ...
                            <div className="lg:col-span-9 space-y-24">
                                    ...
                                    <div className="p-8 lg:p-12 bg-white rounded-[3rem] border border-gray-100 shadow-sm relative overflow-hidden">
                                        ...
                                        <div className="xl:hidden flex flex-col items-center gap-6 py-8">
                                            ...
                                            <div className="flex flex-wrap justify-center gap-3">
                                                <div className="px-4 py-2 bg-white border border-gray-200 rounded-xl shadow-md flex items-center gap-2"><i className="fa-solid fa-door-open text-brand-orange"></i><span className="text-xs font-bold text-brand-dark">Conference Entry</span></div>
                                                <div className="px-4 py-2 bg-white border border-gray-200 rounded-xl shadow-md flex items-center gap-2"><i className="fa-solid fa-clipboard-question text-brand-orange"></i><span className="text-xs font-bold text-brand-dark">Questions & Feedback</span></div>
                                                <div className="px-4 py-2 bg-white border border-gray-200 rounded-xl shadow-md flex items-center gap-2"><i className="fa-solid fa-trophy text-brand-orange"></i><span className="text-xs font-bold text-brand-dark">The Result Announcement</span></div>
                                            </div>
                                        </div>
                                ...
                                <div className="pt-20 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-6 reveal">
                                    ...
                                    <Link href="/olq-report" className="inline-flex items-center justify-center bg-brand-dark text-white h-14 px-10 rounded-full font-bold shadow-xl hover:bg-brand-orange hover:-translate-y-1 transition-all">View OLQ Report</Link>
                                    <div></div>
                                </div>
                            </div>
