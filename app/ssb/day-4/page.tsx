                        ...
                        <div className="grid lg:grid-cols-12 gap-12">
                            ...
                            <div className="lg:col-span-9 space-y-24">
                                    ...
                                    <div className="p-8 lg:p-12 bg-white rounded-[3rem] border border-gray-100 shadow-sm relative overflow-hidden">
                                        ...
                                        <div className="xl:hidden flex flex-col items-center gap-6 py-8">
                                            ...
                                            <div className="flex flex-wrap justify-center gap-3">
                                                <div className="px-4 py-2 bg-white border border-gray-200 rounded-xl shadow-md flex items-center gap-2"><i className="fa-solid fa-users text-brand-orange"></i><span className="text-xs font-bold text-brand-dark">Final Group Task</span></div>
                                                <div className="px-4 py-2 bg-white border border-gray-200 rounded-xl shadow-md flex items-center gap-2"><i className="fa-solid fa-person-running text-brand-orange"></i><span className="text-xs font-bold text-brand-dark">Individual Obstacles</span></div>
                                                <div className="px-4 py-2 bg-white border border-gray-200 rounded-xl shadow-md flex items-center gap-2"><i className="fa-solid fa-medal text-brand-orange"></i><span className="text-xs font-bold text-brand-dark">Command Task</span></div>
                                                <div className="px-4 py-2 bg-white border border-gray-200 rounded-xl shadow-md flex items-center gap-2"><i className="fa-solid fa-comments text-brand-orange"></i><span className="text-xs font-bold text-brand-dark">Personal Interview</span></div>
                                            </div>
                                        </div>
                                ...
                                <div className="pt-20 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-6 reveal">
                                    ...
                                    <Link href="/practice" className="inline-flex items-center justify-center bg-brand-dark text-white h-14 px-10 rounded-full font-bold shadow-xl hover:bg-brand-orange hover:-translate-y-1 transition-all">Start AI Practice</Link>
