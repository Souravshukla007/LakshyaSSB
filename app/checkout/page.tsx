...
export default function Checkout() {
    ...
    return (
        <main className="antialiased overflow-x-hidden selection:bg-brand-orange selection:text-white font-sans bg-brand-bg">
            ...
            <section className="min-h-screen bg-brand-bg pt-40 pb-20 px-6 flex items-center justify-center">
                <div className="max-w-md w-full relative z-10 reveal-scale">
                    <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-2xl">
                        <h2 className="font-hero font-bold text-3xl text-brand-dark mb-2">
                        ...
                        <div className="bg-brand-bg p-6 rounded-2xl mb-8 border border-gray-50">
                            <div className="flex justify-between items-center mb-4">
                                <span className="text-sm font-bold text-brand-dark">Pro Training Plan</span>
                                <span className="text-lg font-bold text-brand-orange">₹249/mo</span>
                            </div>
